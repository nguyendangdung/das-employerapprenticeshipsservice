...
namespace SFA.DAS.EAS.MessageHandlers.Worker.UnitTests.EventHandlers
{
    ...
    public class SentTransferConnectionInvitationEventHandlerTestFixture
    {
        ...
        private SentTransferConnectionInvitationEventHandlerTestFixture AddAccount(Domain.Data.Entities.Account.Account account)
        {
            if (_accounts == null)
        ...
        private SentTransferConnectionInvitationEventHandlerTestFixture AddUserToMockDb(User user, Domain.Data.Entities.Account.Account account, Role role, bool receiveNotifications)
        {
            if (_users == null)
