...
namespace SFA.DAS.EAS.MessageHandlers.Worker.UnitTests.EventHandlers
{
    ...
    public class ApprovedTransferConnectionInvitationEventHandlerTestFixture
    {
        ...
        public Mock<EmployerApprenticeshipsServiceConfiguration> Configuration;
        ...
        public ApprovedTransferConnectionInvitationEventHandlerTestFixture()
        {
            ...
            Handler = new ApprovedTransferConnectionInvitationEventHandler(MessageSubscriberFactory.Object,
                Logger.Object, EmployerAccountDbContext.Object, NotificationsApi.Object, Configuration.Object);
        }
        ...
        private ApprovedTransferConnectionInvitationEventHandlerTestFixture AddAccount(Domain.Data.Entities.Account.Account account)
        {
            if (_accounts == null)
        ...
        private ApprovedTransferConnectionInvitationEventHandlerTestFixture AddUserToMockDb(User user, Domain.Data.Entities.Account.Account account, Role role, bool receiveNotifications)
        {
            if(_users == null)
